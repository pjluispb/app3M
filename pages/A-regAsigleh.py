...
if vercodinv_out in ['asigleh2023', 'test102023']:
    ph1.empty()
    with st.form('fregini'):
        ...
        if ingresaReg:
            ...
            if verifregDB.count==0:
                encuasigleh.put({"nombreu":nombreu, "cedulau":cedulau, "key":str(cedulau), "rol":pastorOlider})
